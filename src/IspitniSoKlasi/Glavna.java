...
public class Glavna
{
    public static void work(SLL<Task> toDo, SLL<Task> inProgress)
    {
        ...
        {
            int maxImportance = 0;
            maxImportance = 2 * dvizi.element.getHours() * dvizi.element.getPriority();
        ...
        SLLNode<Task> dvizi2 = inProgress.getFirst();
        int min = 9999;
        ...
        {
            int minImportance = 0;
            minImportance = 2 * dvizi2.element.getHours() * dvizi2.element.getPriority();
