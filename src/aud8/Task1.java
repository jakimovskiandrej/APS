...
public class Task1 {
    public static void main(String[] args) {
        ...
        for(int i=1;i<n;i++) {
            String valueParent = sc.next();
            String valueChild = sc.next();
            Tree.Node<String> parentNode = nodes.get(valueParent);
            Tree.Node<String> childNode = tree.addChild(parentNode,valueChild);
            nodes.put(valueParent,childNode);
        }
        tree.printTree();
    }
